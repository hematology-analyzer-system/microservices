...
public class AuthControllerTest {
    ...
    @Test
    public void AuthControllerTest_Register_ShouldReturnSuccessMessage() throws Exception {
        RegisterRequest request = new RegisterRequest();
        request.setFullName("John Doe");
        request.setEmail("john.doe@example.com");
        request.setPhone("0123456789");
    ...
    @Test
    public void AuthControllerTest_Register_EmailExists_ShouldReturnBadRequest() throws Exception {
        RegisterRequest request = new RegisterRequest();
        request.setFullName("John Doe");
        request.setEmail("john.doe@example.com");
        request.setPhone("0123456789");
    ...
    @Test
    public void AuthControllerTest_Register_PhoneExists_ShouldReturnBadRequest() throws Exception {
        RegisterRequest request = new RegisterRequest();
        request.setFullName("John Doe");
        request.setEmail("john.doe@example.com");
        request.setPhone("0123456789");
        ...
        response.andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.error").value("Phone already exists"));
    }

    @Test
    public void AuthControllerTest_Login_ShouldReturnToken() throws Exception {
        AuthRequest request = new AuthRequest();
        request.setUsername("john.doe@example.com");
        request.setPassword("password123");
        ...
        given(authManager.authenticate(any(Authentication.class))).willReturn(Mockito.mock(Authentication.class));
        given(userRepository.findByEmail(request.getUsername())).willReturn(user);
        given(jwtService.generateToken(user)).willReturn(token);
    ...
    @Test
    public void AuthControllerTest_Login_InvalidCredentials_ShouldReturnUnauthorized() throws Exception {
        AuthRequest request = new AuthRequest();
        request.setUsername("wrong@example.com");
        request.setPassword("wrongpass");
    ...
    @Test
    public void AuthControllerTest_me_ShouldReturnUserClaims() throws Exception {
        // Arrange
        AuthRequest request = new AuthRequest();
        request.setUsername("john.doe@example.com");
        request.setPassword("password123");
        ...
        // Set up user with roles and privileges
        User user = new User();
        user.setEmail(request.getUsername());
        ...
        privilege.setPrivilegeId(101L);
        privilege.setCode("READ_PRIVILEGE");
        ...
        // Act
        ResultActions response = mockMvc.perform(post("/auth/me")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(request)));
        ...
        response.andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.roles[0].code").value("ROLE_ADMIN"))
                .andExpect(jsonPath("$.privilege_ids[0]").value(101));
    }
